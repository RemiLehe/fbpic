...
def deposit_rho_gpu_linear(x, y, z, w, q,
    ...
    if i < prefix_sum.shape[0]:
        ...
        if frequency_per_cell > 0:
            # Mode 0 (real)
            cuda.atomic.add(rho_m0, (iz0, ir0), R_m0_00)
            cuda.atomic.add(rho_m0, (iz0, ir1), R_m0_10)
            cuda.atomic.add(rho_m0, (iz1, ir0), R_m0_01)
            cuda.atomic.add(rho_m0, (iz1, ir1), R_m0_11)
            # Mode 1 (complex)
...
def deposit_J_gpu_linear(x, y, z, w, q,
    ...
    if i < prefix_sum.shape[0]:
        ...
        if frequency_per_cell > 0:
            # jr: Mode 0
            cuda.atomic.add(j_r_m0, (iz0, ir0), J_r_m0_00)
            cuda.atomic.add(j_r_m0, (iz0, ir1), J_r_m0_10)
            cuda.atomic.add(j_r_m0, (iz1, ir0), J_r_m0_01)
            cuda.atomic.add(j_r_m0, (iz1, ir1), J_r_m0_11)
            # jr: Mode 1
            ...
            # jt: Mode 0
            cuda.atomic.add(j_t_m0, (iz0, ir0), J_t_m0_00)
            cuda.atomic.add(j_t_m0, (iz0, ir1), J_t_m0_10)
            cuda.atomic.add(j_t_m0, (iz1, ir0), J_t_m0_01)
            cuda.atomic.add(j_t_m0, (iz1, ir1), J_t_m0_11)
            # jt: Mode 1
            ...
            # jz: Mode 0
            cuda.atomic.add(j_z_m0, (iz0, ir0), J_z_m0_00)
            cuda.atomic.add(j_z_m0, (iz0, ir1), J_z_m0_10)
            cuda.atomic.add(j_z_m0, (iz1, ir0), J_z_m0_01)
            cuda.atomic.add(j_z_m0, (iz1, ir1), J_z_m0_11)
            # jz: Mode 1
...
def deposit_rho_gpu_cubic(x, y, z, w, q,
    ...
    if i < prefix_sum.shape[0]:
        ...
        if frequency_per_cell > 0:
            ...
            cuda.atomic.add(rho_m0, (iz0, ir0), R_m0_00)
            cuda.atomic.add(rho_m0, (iz0, ir1), R_m0_10)
            cuda.atomic.add(rho_m0, (iz0, ir2), R_m0_20)
            cuda.atomic.add(rho_m0, (iz0, ir3), R_m0_30)
            cuda.atomic.add(rho_m0, (iz1, ir0), R_m0_01)
            cuda.atomic.add(rho_m0, (iz1, ir1), R_m0_11)
            cuda.atomic.add(rho_m0, (iz1, ir2), R_m0_21)
            cuda.atomic.add(rho_m0, (iz1, ir3), R_m0_31)
            cuda.atomic.add(rho_m0, (iz2, ir0), R_m0_02)
            cuda.atomic.add(rho_m0, (iz2, ir1), R_m0_12)
            cuda.atomic.add(rho_m0, (iz2, ir2), R_m0_22)
            cuda.atomic.add(rho_m0, (iz2, ir3), R_m0_32)
            cuda.atomic.add(rho_m0, (iz3, ir0), R_m0_03)
            cuda.atomic.add(rho_m0, (iz3, ir1), R_m0_13)
            cuda.atomic.add(rho_m0, (iz3, ir2), R_m0_23)
            cuda.atomic.add(rho_m0, (iz3, ir3), R_m0_33)
            # Mode 1 (real)
            cuda.atomic.add(rho_m1.real, (iz0, ir0), R_m1_00.real)
            cuda.atomic.add(rho_m1.imag, (iz0, ir0), R_m1_00.imag)
            cuda.atomic.add(rho_m1.real, (iz0, ir1), R_m1_10.real)
...
def deposit_J_gpu_cubic(x, y, z, w, q,
    ...
    if i < prefix_sum.shape[0]:
        ...
        if frequency_per_cell > 0:
            ...
            cuda.atomic.add(j_r_m0, (iz0, ir0), J_r_m0_00)
            cuda.atomic.add(j_r_m0, (iz0, ir1), J_r_m0_10)
            cuda.atomic.add(j_r_m0, (iz0, ir2), J_r_m0_20)
            cuda.atomic.add(j_r_m0, (iz0, ir3), J_r_m0_30)
            cuda.atomic.add(j_r_m0, (iz1, ir0), J_r_m0_01)
            cuda.atomic.add(j_r_m0, (iz1, ir1), J_r_m0_11)
            cuda.atomic.add(j_r_m0, (iz1, ir2), J_r_m0_21)
            cuda.atomic.add(j_r_m0, (iz1, ir3), J_r_m0_31)
            cuda.atomic.add(j_r_m0, (iz2, ir0), J_r_m0_02)
            cuda.atomic.add(j_r_m0, (iz2, ir1), J_r_m0_12)
            cuda.atomic.add(j_r_m0, (iz2, ir2), J_r_m0_22)
            cuda.atomic.add(j_r_m0, (iz2, ir3), J_r_m0_32)
            cuda.atomic.add(j_r_m0, (iz3, ir0), J_r_m0_03)
            cuda.atomic.add(j_r_m0, (iz3, ir1), J_r_m0_13)
            cuda.atomic.add(j_r_m0, (iz3, ir2), J_r_m0_23)
            cuda.atomic.add(j_r_m0, (iz3, ir3), J_r_m0_33)
            # jr: Mode 1
            cuda.atomic.add(j_r_m1.real, (iz0, ir0), J_r_m1_00.real)
            cuda.atomic.add(j_r_m1.imag, (iz0, ir0), J_r_m1_00.imag)
            cuda.atomic.add(j_r_m1.real, (iz0, ir1), J_r_m1_10.real)
            ...
            cuda.atomic.add(j_t_m0, (iz0, ir0), J_t_m0_00)
            cuda.atomic.add(j_t_m0, (iz0, ir1), J_t_m0_10)
            cuda.atomic.add(j_t_m0, (iz0, ir2), J_t_m0_20)
            cuda.atomic.add(j_t_m0, (iz0, ir3), J_t_m0_30)
            cuda.atomic.add(j_t_m0, (iz1, ir0), J_t_m0_01)
            cuda.atomic.add(j_t_m0, (iz1, ir1), J_t_m0_11)
            cuda.atomic.add(j_t_m0, (iz1, ir2), J_t_m0_21)
            cuda.atomic.add(j_t_m0, (iz1, ir3), J_t_m0_31)
            cuda.atomic.add(j_t_m0, (iz2, ir0), J_t_m0_02)
            cuda.atomic.add(j_t_m0, (iz2, ir1), J_t_m0_12)
            cuda.atomic.add(j_t_m0, (iz2, ir2), J_t_m0_22)
            cuda.atomic.add(j_t_m0, (iz2, ir3), J_t_m0_32)
            cuda.atomic.add(j_t_m0, (iz3, ir0), J_t_m0_03)
            cuda.atomic.add(j_t_m0, (iz3, ir1), J_t_m0_13)
            cuda.atomic.add(j_t_m0, (iz3, ir2), J_t_m0_23)
            cuda.atomic.add(j_t_m0, (iz3, ir3), J_t_m0_33)
            # jt: Mode 1
            cuda.atomic.add(j_t_m1.real, (iz0, ir0), J_t_m1_00.real)
            cuda.atomic.add(j_t_m1.imag, (iz0, ir0), J_t_m1_00.imag)
            cuda.atomic.add(j_t_m1.real, (iz0, ir1), J_t_m1_10.real)
            ...
            cuda.atomic.add(j_z_m0, (iz0, ir0), J_z_m0_00)
            cuda.atomic.add(j_z_m0, (iz0, ir1), J_z_m0_10)
            cuda.atomic.add(j_z_m0, (iz0, ir2), J_z_m0_20)
            cuda.atomic.add(j_z_m0, (iz0, ir3), J_z_m0_30)
            cuda.atomic.add(j_z_m0, (iz1, ir0), J_z_m0_01)
            cuda.atomic.add(j_z_m0, (iz1, ir1), J_z_m0_11)
            cuda.atomic.add(j_z_m0, (iz1, ir2), J_z_m0_21)
            cuda.atomic.add(j_z_m0, (iz1, ir3), J_z_m0_31)
            cuda.atomic.add(j_z_m0, (iz2, ir0), J_z_m0_02)
            cuda.atomic.add(j_z_m0, (iz2, ir1), J_z_m0_12)
            cuda.atomic.add(j_z_m0, (iz2, ir2), J_z_m0_22)
            cuda.atomic.add(j_z_m0, (iz2, ir3), J_z_m0_32)
            cuda.atomic.add(j_z_m0, (iz3, ir0), J_z_m0_03)
            cuda.atomic.add(j_z_m0, (iz3, ir1), J_z_m0_13)
            cuda.atomic.add(j_z_m0, (iz3, ir2), J_z_m0_23)
            cuda.atomic.add(j_z_m0, (iz3, ir3), J_z_m0_33)
            # jz: Mode 1
            cuda.atomic.add(j_z_m1.real, (iz0, ir0), J_z_m1_00.real)
            cuda.atomic.add(j_z_m1.imag, (iz0, ir0), J_z_m1_00.imag)
            cuda.atomic.add(j_z_m1.real, (iz0, ir1), J_z_m1_10.real)
